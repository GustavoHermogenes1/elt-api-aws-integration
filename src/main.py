...
def pipeline():
    ...
    ranking_parquet = transform_json_to_parquet(ranking, 'rankings.parquet', SILVER_DIR)
    ...
    upload_data_to_s3(ranking_parquet, S3_BUCKET, f'{S3_SILVER_PREFIX}/ranking/ranking.parquet')
